...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/LSCircleProgressView/LSCircleProgressView.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/StringLogger/StringLogger.framework"
